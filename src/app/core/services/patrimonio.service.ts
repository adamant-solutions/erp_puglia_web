...
export class PatrimonioService {
  ...
  getFilteredPatrimonio(params: PatrimonioSearchParams): Observable<any> {
    ...
    return this.http
      .get<Patrimonio[]>(this.patrimonioUrl, {
        params: httpParams,
        observe: 'response',
      })
      .pipe(
  ...
  getPatrimonioById(id: number): Observable<Patrimonio> {
    return this.http
      .get<Patrimonio>(`${this.patrimonioUrl}/${id}`)
      .pipe(catchError((error) => throwError(() => error)));
  }

  addPatrimonio(formData: FormData): Observable<Patrimonio> {
    return this.http
      .post<Patrimonio>(`${this.patrimonioUrl}`, formData)
      .pipe(catchError((error) => throwError(() => error)));
  }
  ...
  modificaPatrimonio(
    ...
    formData.append(
      'unitaImmobiliare',
      unitaImmobiliareBlob,
      'unitaImmobiliare.json'
    );
    ...
    return this.http
      .put<Patrimonio>(`${this.patrimonioUrl}`, formData)
      .pipe(
        catchError((error) =>
          throwError(
            () => error
